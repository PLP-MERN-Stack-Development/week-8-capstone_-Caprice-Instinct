...
export const BOOK_MY_LIST_REQUEST = 'BOOK_MY_LIST_REQUEST';
export const BOOK_MY_LIST_SUCCESS = 'BOOK_MY_LIST_SUCCESS';
export const BOOK_MY_LIST_FAIL = 'BOOK_MY_LIST_FAIL';
export const BOOK_MY_LIST_RESET = 'BOOK_MY_LIST_RESET';